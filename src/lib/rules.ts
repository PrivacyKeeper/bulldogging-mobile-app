...
//
// Every app's table is named for its event (SW_PENALTIES), which is why this file
// is per-app and the screen that reads it is not.

import { SW_PENALTIES } from './scoring/index.ts';
...
export const RUN_ENDING_RULES: Record<string, RunEndingRule> = SW_PENALTIES;

export const RULES_HEADING = 'What ends your run';
export const RULES_INTRO =
  'Every penalty and disqualification on a steer wrestling run, straight out of the rule engine this app scores with.';
